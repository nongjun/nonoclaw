...
description: 项目结构化知识库初始化，基于渐进式披露原则从零搭建AGENTS.md、架构.md和文档目录。仅用于首次建立知识库，后续维护和文档整理请使用 doc-gardener 技能。当用户提到"建立知识库""初始化文档""搭建文档结构"时使用。
---
...
- 基于瑞小美AiOS项目的实际示例，见 [examples.md](examples.md)
